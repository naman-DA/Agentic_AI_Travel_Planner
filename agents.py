...
def itinerary_agent(state: TravelState):
    flight_results = str(state.get("flight_results", ""))[:2200]
    hotel_results = str(state.get("hotel_results", ""))[:1800]
    weather_results = str(state.get("weather_results", ""))[:1000]
    budget_results = str(state.get("budget_results", ""))[:1800]
